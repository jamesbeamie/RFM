...
from .models import Potraits
from ..authentication.serializers import RegistrationSerializer
from django.db.models import Avg


class PotraitsSerializer(serializers.ModelSerializer):
    """
        Potraits model serializers
    """
    ...
    def create_slug(self, title):
        ...
        origin = 1
        unique_slug = a_slug
        while Potraits.objects.filter(slug=unique_slug).exists():
